    ...
    return(
        <Fragment >
            ...
            <button type="button" className="text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 mt-4">Back to Main Page</button>
                    ...
                    <div className =" ">  
                        {
                            ...
                            <div className="ml-10">
                                <div className="">
                                    <span className= "text-2xl text-blue-700 font-mono hover:text-blue-600">ข้อมูล ของ วันที่ {input.date1Val!=''?input.date1Val:searchParams.get("date1")} - {input.date2Val!=''?input.date2Val:searchParams.get("date2")}</span>
                                </div>
                            </div>
                            :
                ...
                <SummaryTable data ={userSummaryData}  getLink = {getLink}/>
            </div> 
        </Fragment>
    )
}
